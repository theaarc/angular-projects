...
import { Template2Component } from './all-cv/template/template2/template2.component';
import { Template3Component } from './all-cv/template/template3/template3.component';
